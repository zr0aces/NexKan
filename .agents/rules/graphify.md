...
This project has a graphify knowledge graph at graphify-out/. Canonical description: [`docs/ai-agent-guidelines.md`](../../docs/ai-agent-guidelines.md#graphify-codebase-knowledge-graph).
